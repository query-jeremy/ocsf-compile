...
def get_repo():
    repo = Repository()
    # Needs:
    #  categories.json entry
    #  event with uid and activity_id
    #  event in an extension with uid and activity_id
...
def test_apply():
    ...
    assert r == [("attributes", "category_uid"), ("attributes", "class_uid"), ("attributes", "type_uid")]
